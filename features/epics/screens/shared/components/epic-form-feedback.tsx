...
export function EpicFormFeedback({
  ...
  if (success) {
    return (
      <div
        className={`${successClassName ?? ''} overflow-hidden transition-[max-height,opacity,margin,transform] duration-500 ease-out ${
          visible
            ? 'mb-5 max-h-14 translate-y-0 opacity-100 md:mb-8'
