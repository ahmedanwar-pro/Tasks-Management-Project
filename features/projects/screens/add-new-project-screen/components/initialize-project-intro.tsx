...
function InitializeIcon(): ReactElement {
  return (
    <svg
      aria-hidden="true"
...
export function InitializeProjectIntro(): ReactElement {
  return (
