...
const projectTasksListSearchDebounceMs = 400;

export function useProjectTasksListSearch(onDebouncedSearchChange: () => void) {
  ...
  useEffect(() => {
    ...
    }, projectTasksListSearchDebounceMs);
  ...
  return { debouncedSearchTerm, onSearchTermChange, searchTerm };
}
